...
public class Medios extends Automoveis{
	...
	public Medios(String placa, String tipo, double ano, double valordiaria, int vago,  int dias,int day, int month, int year, int atraso) {
    ...
    @Override
	public double precoMedio(){  if(year-ano>3){return (atraso) * valordiaria*(1-(0.05*3));
							    }	else{
									   			return (atraso) * valordiaria*(1-(0.05*(year-ano)));
								    } 
	}
